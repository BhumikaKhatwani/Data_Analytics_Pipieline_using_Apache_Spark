...
labelIndexer = StringIndexer(inputCol="label", outputCol="indexedLabel").fit(rawTrainData)
# Automatically identify categorical features, and index them.
# We specify maxCategories so features with > 4 distinct values are treated as continuous.
featureIndexer =\
    VectorIndexer(inputCol="features", outputCol="indexedFeatures", maxCategories=4).fit(rawTrainData)
...
model = pipeline.fit(rawTrainData)
